...
//                        node(MPTv2Blocks.);
            ...
            node(MPTv2Blocks.roombaFactory, () -> {
                node(MPTv2UnitTypes.roomba, ItemStack.with(MPTv2Items.unitResearchPack, 40), () -> {
                    node(MPTv2UnitTypes.jibakuRoomba, ItemStack.with(MPTv2Items.unitResearchPack, 80), () -> {
                        node(MPTv2UnitTypes.jibakuNukeRoomba, ItemStack.with(MPTv2Items.unitResearchPack, 200), () -> {});
                        node(MPTv2UnitTypes.attackRoomba, ItemStack.with(MPTv2Items.unitResearchPack, 120), () -> {
//                            node(MPTv2UnitTypes.);
                        });
                    });
                    node(MPTv2UnitTypes.miningRoomba, ItemStack.with(MPTv2Items.unitResearchPack, 30), () -> {
                        node(MPTv2UnitTypes.repairRoomba, ItemStack.with(MPTv2Items.unitResearchPack, 60), () -> {
                            node(MPTv2UnitTypes.builderRoomba, ItemStack.with(MPTv2Items.unitResearchPack, 90), () -> {
                                node(MPTv2UnitTypes.rebuildRoomba, ItemStack.with(MPTv2Items.unitResearchPack, 120), () -> {
                                    node(MPTv2UnitTypes.shieldRoomba, ItemStack.with(MPTv2Items.unitResearchPack, 180), () -> {});
                                });
                            });
                        });
                    });
